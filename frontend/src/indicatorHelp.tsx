export const indicatorHelp = {
  S: { title: '實驗性結構暴露', meaning: '綜合青年集中程度與 AI 職務暴露，描述該職業面對 AI 變化的結構性暴露。', formula: 'S = 100 × √(A × B)', method: '目前後端將 A 與 B 以同一尺度組合，H、D 與 C 獨立呈現。這是團隊定義的實驗性指標，不是 AI 自動產生的公式。', interpretation: '數值越高，代表青年集中與 AI 職務暴露的組合訊號較高；不代表相同比例的人會失業或被取代。', limitation: 'A 的年齡範圍由當次資料快照揭露；跨來源分類與權重仍需持續核對。' },
